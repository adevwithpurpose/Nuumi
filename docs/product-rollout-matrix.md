...
| ByeBark Ultrasonic Device | `byebark-ultrasonic-device` | `https://funnels-build.thisisatestsiteonly.com/b7ae061e-d35b-43ad-8ff5-200b7c38d448/pdp-byebark` | `docs/products/byebark.md` | `product.byebark.json` | `Pet Device` | `Nuumipet` | `complete` | `manual_followup` | `complete` | `complete` | `complete` | Rebuilt on the EnerCanis clone architecture with EnerCanis as the baseline scale system for typography, spacing, and card rhythm. |
| CalmiCollar | `calmi-collar` | `https://funnels-build.thisisatestsiteonly.com/89f23665-032b-4c9c-9201-27d8451c6546/26c598eb-c11a-44c6-bb9b-a72fc0b3533e.html` | `docs/products/calmicollar.md` | `product.calmicollar.json` | `Pet Wellness Collar` | `Nuumipet` | `complete` | `manual_followup` | `complete` | `complete` | `complete` | Rebuilt on the EnerCanis/ByeBark modular PDP baseline with a dedicated calming-collar hero, NeuroEase mechanism section, symptom checklist grid, shared guarantee, and shared FAQ. |
| PawPoint Ear Wipes | `pawpoint-ear-wipes` | `https://funnels-build.thisisatestsiteonly.com/1efef29f-0d50-4911-897e-b86a970a2d4a/pdp-pawpoint` | `docs/products/pawpoint.md` | `product.pawpoint.json` | `Pet Hygiene` | `Nuumipet` | `complete` | `manual_followup` | `complete` | `complete` | `complete` | Rebuilt on the EnerCanis/ByeBark modular baseline with a consumable-product hero, anatomy agitation section, how-to flow, superior-feature checklist, shared guarantee, and shared FAQ. |
| The Leash Walk Formula | `nuumipet-core-wellness-bundle` | `https://funnels-build.thisisatestsiteonly.com/1efef29f-0d50-4911-897e-b86a970a2d4a/nd-fb-lwf` | `docs/products/core-wellness-bundle.md` | `product.bundle.json` | `Digital Dog Training Program` | `Nuumipet` | `complete` | `manual_followup` | `complete` | `complete` | `complete` | Rebuilt as the digital adaptation of the EnerCanis baseline with a single-offer buy box, what-you-get section, bonus stack, trainer authority block, shared guarantee, and shared FAQ. |
